...
let conversion graphe = map graphe (fun (flot,capa) -> (string_of_int flot) ^ "/" ^ (string_of_int capa))  (* conversion d'un ford_graph en un graph avec un label unique sous forme de string*)
